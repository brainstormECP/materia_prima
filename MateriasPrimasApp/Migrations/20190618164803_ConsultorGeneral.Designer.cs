...
namespace MateriasPrimasApp.Migrations
{
    ...
    [Migration("20190618164803_ConsultorGeneral")]
    partial class ConsultorGeneral
    {
            ...
            modelBuilder.Entity("MateriasPrimasApp.Models.Submayor", b =>
                {
                    ...
                    b.HasData(
                        new { AlmacenId = 1, ProductoId = 1, Cantidad = 0m, UnidadId = 1 },
                        new { AlmacenId = 2, ProductoId = 1, Cantidad = 0m, UnidadId = 1 },
                        new { AlmacenId = 3, ProductoId = 1, Cantidad = 0m, UnidadId = 1 },
                        new { AlmacenId = 4, ProductoId = 1, Cantidad = 0m, UnidadId = 1 },
                        new { AlmacenId = 1, ProductoId = 2, Cantidad = 0m, UnidadId = 3 },
                        new { AlmacenId = 2, ProductoId = 2, Cantidad = 0m, UnidadId = 3 },
                        new { AlmacenId = 3, ProductoId = 2, Cantidad = 0m, UnidadId = 3 },
                        new { AlmacenId = 4, ProductoId = 2, Cantidad = 0m, UnidadId = 3 }
                    );
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1", ConcurrencyStamp = "4eb3d1f8-7a1d-4671-b1c8-7e459e62451a", Name = "Administrador", NormalizedName = "ADMINISTRADOR" },
                        new { Id = "2", ConcurrencyStamp = "b53080ab-70cc-41de-a2d0-11c2164854fa", Name = "Comercial", NormalizedName = "COMERCIAL" },
                        new { Id = "3", ConcurrencyStamp = "4afebbee-d63c-4907-a598-7aeb493de452", Name = "Consultor", NormalizedName = "CONSULTOR" },
                        new { Id = "4", ConcurrencyStamp = "4b697eee-cd55-473d-a6f0-6876a38a852b", Name = "Comercial_General", NormalizedName = "COMERCIAL_GENERAL" }
                    );
                });
            ...
            modelBuilder.Entity("MateriasPrimasApp.Models.CasaCompra", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 6, Nombre = "Casa de compra1 Matanzas", UebId = 1 },
                        new { Id = 7, Nombre = "Casa de compra2 Matanzas", UebId = 1 },
                        new { Id = 8, Nombre = "Casa de Limonar", UebId = 1 },
                        new { Id = 9, Nombre = "Casa de compra Unión de Reyes", UebId = 1 },
                        new { Id = 10, Nombre = "Casa de compra Jovellanos", UebId = 3 },
                        new { Id = 11, Nombre = "Casa de compra Betancourt", UebId = 3 },
                        new { Id = 12, Nombre = "Casa de compra Colón", UebId = 2 },
                        new { Id = 13, Nombre = "Casa de compra Perico", UebId = 2 },
                        new { Id = 14, Nombre = "Casa de compra Calimete", UebId = 2 },
                        new { Id = 15, Nombre = "Casa de compra Los Arabos", UebId = 2 },
                        new { Id = 16, Nombre = "Casa de compra Martí", UebId = 2 },
                        new { Id = 17, Nombre = "Casa de compra Jagüey", UebId = 4 },
                        new { Id = 18, Nombre = "Casa de compra Ciénaga de Zapata", UebId = 4 },
                        new { Id = 19, Nombre = "Casa de compra1 Cárdenas", UebId = 5 },
                        new { Id = 20, Nombre = "Casa de compra2 Cárdenas", UebId = 5 },
                        new { Id = 21, Nombre = "Casa de compra Varadero", UebId = 5 }
                    );
                });
            ...
            modelBuilder.Entity("MateriasPrimasApp.Models.UEB", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Nombre = "UEB Matanzas", Telefono = "262100", Municipio = "Matanzas" },
                        new { Id = 2, Nombre = "UEB Colón", Telefono = "371304", Municipio = "Colón" },
                        new { Id = 3, Nombre = "UEB Jovellanos", Telefono = "312008", Municipio = "Jovellanos" },
                        new { Id = 4, Nombre = "UEB Jagüey Grande", Telefono = "572487", Municipio = "Jagüey Grande" },
                        new { Id = 5, Nombre = "UEB Colón", Telefono = "371304", Municipio = "Cárdenas" }
                    );
                });
