    ...
    public partial class primera : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetallesDeVenta_UM_UnidadId",
                        column: x => x.UnidadId,
                        principalTable: "UM",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", "03425ba7-c050-498a-9c66-bef5b2c9f09f", "Administrador", "ADMINISTRADOR" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "2", "828ec017-261c-4021-bec1-f2198fec1166", "Comercial", "COMERCIAL" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "3", "df0c2be7-0cad-4919-bdc9-a41a36a0f4e3", "Consultor", "CONSULTOR" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesDeVenta_UnidadId",
                table: "DetallesDeVenta",
                column: "UnidadId");
