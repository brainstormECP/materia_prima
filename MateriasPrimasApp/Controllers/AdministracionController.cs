...
namespace MateriasPrimasApp.Controllers
{
    public class AdministracionController : Controller
    {
        ...
        public AdministracionController(UserManager<ApplicationUser> userManager, ApplicationDbContext context, RoleManager<IdentityRole> roleManager, SignInManager<ApplicationUser> signInManager)
        {
        ...
        {
            var duplicated = _userManager.FindByNameAsync(viewModel.UserName);
            if(duplicated != null)
            {
